...
int main(void) {
    ...
    jogador.cor = PINK;   // Cor verde-lima definida na tabela cromática da Raylib 
    ...
    while (!fecharJogo &&!WindowShouldClose()) {
        ...
        switch (estadoAtual) {
            case MENU: {
                ...
                if (IsKeyPressed(KEY_ENTER)) {
                    if (opcaoSelecionada == 0) {
                        ...
                        projetil.ativo = false; 
                        for (int i = 0; i < 10; i++) luas[i].ativo = true; //luas volta quando inicia dnv
            ...
            case JOGANDO: {
                ...
                if (IsKeyPressed(KEY_SPACE) && !projetil.ativo) {
                    projetil.posicao = (Vector2){ jogador.posicao.x, jogador.posicao.y - 20.0f };
                    projetil.velocidade = (Vector2){ 0.0f, -8.0f };
                    projetil.ativo = true;
                }
                ...
                if (projetil.ativo) {
                    ...
                    if (projetil.posicao.y < 0.0f) {
                        projetil.ativo = false;
                    }
                }
                for (int i = 0; i < 10; i++) {
                    if (luas[i].ativo && projetil.ativo &&
                        CheckCollisionCircles(projetil.posicao, raioPewpew, luas[i].posicao, raioLua)) {
                        luas[i].ativo = false;
                        projetil.ativo = false; //Checa se pewpew batendo em lua, se sim, lua tchau tchau
                        break;
                    }
                }
                for (int i = 0; i < 10; i++) {
                    if (luas[i].ativo &&
                        CheckCollisionCircles(jogador.posicao, raioNave, luas[i].posicao, raioLua)) {
                        estadoAtual = MENU;
                        break; //checa se betinha bateu na lua, se sim, betinha tchau tchau
                    }
                }
                break;
            }
        ...
        switch (estadoAtual) {
            ...
            case JOGANDO: {
                ...
                for (int i=0;i<10;i++){
                    ...
                    DrawCircleGradient(centro, raioLua ,luas[i].cor,PURPLE);
                    }
                }
                ...
                if (projetil.ativo) {
                    DrawCircleV(projetil.posicao, 4.0f, BLUE);
                }
                break;
            }
        }
